...
@section('title', __('user::dashboard.companies.routes.update'))
@section('content')
  ...
  <div class="page-content">
    <div class="page-bar">
      <ul class="page-breadcrumb">
        ...
        <li>
          <a href="#">{{ __('user::dashboard.companies.routes.update') }}</a>
        </li>
      </ul>
    </div>
          ...
          <div class="col-md-9">
            <div class="tab-content">
              ...
              <div class="tab-pane active fade in" id="global_setting">
                <h3 class="page-title">{{ __('user::dashboard.companies.form.general') }}</h3>
                <div class="col-md-10">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      ...
                      <select name="categories[]" class="form-control selected" data-name="categories.*" multiple>
                        <option value="" disabled>{{ __('user::dashboard.companies.form.categories') }}</option>
              ...
              <div class="tab-pane office-data fade in" id="company">
                <h3 class="page-title">{{ __('user::dashboard.companies.form.company') }}</h3>
                <div class="col-md-10">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <textarea name="description_work" class="form-control" data-name="description_work">{{ optional($company)->description_work }}</textarea>
                      <div class="help-block"></div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <select name="city_id" id="office_city" disabled data-current="{{ optional($company)->city_id }}" class="form-control"
                        data-name="city_id">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <select name="state_id" id="office_state" disabled data-current="{{ optional($company)->state_id }}" class="form-control"
                        data-name="state_id">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      ...
                      <input type="text" name="socials[{{ $loop->index }}][link]" value="{{ optional($value)['link'] }}" class="form-control"
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <input type="string" name="lat" class="form-control" data-name="lat" value="{{ $user->company->lat }}">
                      <div class="help-block"></div>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <input type="string" name="long" class="form-control" data-name="long" value="{{ $user->company->lat }}">
                      <div class="help-block"></div>
                    </div>
                  </div>
              ...
              <div class="tab-pane fade in office-data" id="currentSubscription">
                <h3 class="page-title">{{ __('user::dashboard.companies.form.currentSubscription.tab') }}</h3>
                <div class="col-md-10">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      ...
                      <select name="package_id" class="form-control selected" data-name="package_id">
                        ...
                        <option value="{{ $package->id }}" {{ optional($user->currentSubscription)->package_id == $package->id ? 'selected' : '' }}>
                  ...
                  <div class="sub-data" style="display: none">
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <input type="text" name="subscription[current_use]" class="form-control" value="{{ optional($currentSubscription)->current_use }}"
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <input type="text" name="subscription[max_use]" value="{{ optional($currentSubscription)->max_use }}" class="form-control"
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <input type="number" name="subscription[duration_of_ads]" value="{{ optional($currentSubscription)->duration_of_ads }}"
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <div class="input-group input-medium date date-picker" data-name="subscription.start_at" data-date-format="yyyy-mm-dd"
                          ...
                          <input type="text" class="form-control" name="subscription[start_at]" value="{{ optional($currentSubscription)->start_at }}">
                          <span class="input-group-btn">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <div class="input-group input-medium date date-picker" data-name="subscription.end_at" data-date-format="yyyy-mm-dd"
                          data-date-start-date="+0d">
                          <input type="text" class="form-control" name="subscription[end_at]" value="{{ optional($currentSubscription)->end_at }}">
                          <span class="input-group-btn">
                            <button class="btn default" type="button">
                              <i class="fa fa-calendar"></i>
                            </button>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <input type="text" name="subscription[money]" min="0" value="{{ optional($currentSubscription)->money }}" class="form-control"
