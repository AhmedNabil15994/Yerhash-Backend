...
class AdsController extends Controller
{
    ...
    public function __construct(Repo $repo, CategoryRepository $category, UserRepository $users)
    {
        $this->repo = $repo;
    ...
    public function edit($id)
    {
        ...
        $users = $this->users->getAllActiveByType($model->user_type);

        return view('qsale::dashboard.ads.edit', compact('model', 'mainCategories', 'users'));
    }
