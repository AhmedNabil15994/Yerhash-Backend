...
@section('content')
  <div class="page-content-wrapper">
    <div class="page-content">
      ...
      <div class="row">
        <form id="updateForm" page="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data"
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane active fade in" id="general">
                  ...
                  <div class="col-md-10">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <input type="text" min="0" value="{{ $model->price }}" name="price" id="price" class="form-control"
                          data-name="price">
                        <div class="help-block"></div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <input type="text" name="mobile" value="{{ $model->mobile }}" id="mobile" class="form-control"
                          data-name="mobile">
                        <div class="help-block"></div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <input type="checkbox" class="make-switch" @if ($model->hide_private_number) checked @endif value="1"
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <input type="text" class="form-control" disabled value="{{ $model->user_type }}">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <label class="col-md-2">
                        {{ __('qsale::dashboard.ads.form.video') }}
                      </label>
                      <div class="col-md-9">
                        <div class="input-group">
                          <span class="input-group-btn">
                            <a data-input="video" data-preview="holder" class="btn btn-primary">
                              <i class="fa fa-video-camera"></i>
                              {{-- {{ __('apps::dashboard.buttons.upload') }} --}}
                            </a>
                          </span>
                          <input name="video" class="form-control video" type="file">

                        </div>
                        @if ($videoUrl = optional($model->getFirstMedia('video'))->getUrl() ?? null)
                          <div class="holder" style="margin-top:15px;max-height:100px;">
                            <video width="500px" height="150px" controls="controls">
                              <source src="{{ $videoUrl }}" type="video/mp4" />
                            </video>
                          </div>
                        @endif
                        <input type="hidden" data-name="video">
                        <div class="help-block"></div>
                      </div>
                    </div>
                        ...
                        <select class="form-control select2" name="status">
                          ...
                          @foreach (Modules\QSale\Enum\AdsStatus::getConstList() as $status)
                            @if (!in_array($status, ['wait']))
                              <option value="{{ $status }}" {{ $model->status == $status ? 'selected' : '' }}>{{ $status }}
                              </option>
                            @endif
                          @endforeach
                        </select>
                    ...
                    <div class="col-md-9">
                      <select name="city_id"
                        id="city"
                        disabled
                        data-current="{{optional($address)->city_id}}"
                        class="form-control"
                        data-name="city_id">
                    ...
                    <div class="col-md-9">
                      <select name="state_id"
                        id="state"
                        disabled
                        data-current="{{optional($address)->state_id}}"
                        class="form-control"
                        data-name="state_id">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <select name="ad_types[]" id="ad_types" class="form-control select2" multiple data-name="ad_types.*">
                          @foreach ($ad_types as $ad_type)
                            <option value="{{ $ad_type->id }}" {{ $model->adTypes->contains('id', $ad_type->id) ? 'selected' : '' }}>
                              {{ $ad_type->name }}</option>
                          @endforeach
                        </select>
                        <div class="help-block"></div>
                  ...
                  <div class="col-md-10">
                      ...
                      <div class="col-md-9">
                        <select name="user_id" id="user_id" disabled class="form-control select2" data-name="user_id">
                          ...
                          @foreach ($users as $user)
                            <option value="{{ $user->id }}" {{ $model->user_id == $user->id ? 'selected' : '' }}> {{ $user->name }}
                    ...
                    @if ($model->status == 'wait')
                      <div class="form-group">
                        ...
                        <div class="col-md-9">
                          <input type="checkbox" class="make-switch" @if ($model->is_paid) checked @endif value="1"
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <input type="number" min="0" class="form-control" cldata-size="small" value="{{ $model->ads_price }}"
                          name="ads_price">
                        <div class="help-block"></div>
                      </div>
                    </div>
                ...
                <div class="tab-pane fade in" id="categories">
                  ...
                  <div id="jstree">
                    ...
                    @include('qsale::dashboard.tree.ads.edit', ['mainCategories' => $mainCategories, 'model' => $model])
                  </div>
                  <div class="form-group">
                  ...
                  <div class="row" id="attrbiutes">
                    @forelse ($model->attributes as $key=> $attribute)
                      <div class="form-group">
                        ...
                        <div class="col-md-9">
                          <input type="hidden" name="adsAttributes[{{ $key }}][attribute_id]"
                          ...
                          @if ($attribute->attribute->type == 'drop_down')
                            <select class="form-control" name="adsAttributes[{{ $key }}][option_id]">
                              @forelse ($attribute->attribute->options as $option)
                                <option value="{{ $option->id }}" {{ $option->id == $attribute->option_id ? 'selected' : '' }}>
                                  {{ $option->value }}</option>
                              @empty
                              @endforelse
                            </select>
                            ...
                            <div class="row">
                              @forelse ($attribute->attribute->options as $option)
                                <div class="col-md-4">
                                  ...
                                  <input type="radio" name="adsAttributes[{{ $key }}][option_id]"
                                    {{ $option->id == $attribute->option_id ? 'checked' : '' }} id="radi_{{ $option->id }}"
                                    value="{{ $option->id }}">
                                </div>
                              @empty
                              @endforelse
                          ...
                          @elseif($attribute->attribute->type == 'boolean')
                            <input type="checkbox" class="" name="adsAttributes[{{ $key }}][value]"
                              {{ $attribute->value ? 'checked' : '' }} />
                          @else
                            <input type="{{ $attribute->attribute->type }}" class="form-control"
                              name="adsAttributes[{{ $key }}][value]" value="{{ $attribute->value }}" />
                          @endif
                          <div class="help-block"></div>
                        </div>
                      </div>
                      ...
                      <div class="row group_address">
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <div class="col-md-9">
                              <select name="address[{{ $key }}][city_id]" id="city" disabled
                                data-current="{{ $address->city_id }}" class="form-control city-address">
                        ...
                        <div class="col-md-3">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-9">
                              <select name="address[{{ $key }}][state_id]" id="state" disabled
                                data-current="{{ $address->state_id }}" class="form-control state-address">
                      ...
                      <div class="row group_address">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <div class="col-md-9">
                              <select name="address[0][city_id]" id="city" disabled data-current=""
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-9">
                              <select name="address[0][state_id]" id="state" disabled data-current=""
